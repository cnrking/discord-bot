...
const CONFIG = {
    ...
    BOT_TOKEN: 'MTQ3ODExMzI0MDAyNTI3MjU5NQ.GmWPDL.eWcE5pTWZHcWWIu4xacBVa6KZQpgpePi-bv_to',
    CLIENT_ID: '1478113240025272595',
    API_PORT: 3001,
...
api.listen(CONFIG.API_PORT, () => {
    console.log('[API] Key API: http://localhost:' + CONFIG.API_PORT);
});
